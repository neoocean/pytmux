...
검출은 엄격화로 고쳤지만(docs/internal/TOKEN_SAVING_SCENARIO.md §2.1), **이미 적힌 과거
...
이제 토큰 저장은 SQLite(db/claude-tokens.db)가 표준이며(docs/internal/TOKEN_USAGE_STORAGE_DESIGN.md),
