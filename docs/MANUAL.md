...
> 화면 그림은 모두 코드블록 안에 ASCII 로 재현했습니다. 실제 색(활성 패널 파란 테두리,
> 상태줄 색 등)은 글로 보충했습니다.
>
...
이어서 오른쪽 패널을 `prefix "` 로 상하 분할하면 이렇게 됩니다.
...
단축키를 외우지 않아도 메뉴로 거의 모든 동작을 하실 수 있습니다.
...
방향키로 선택하고 Enter 로 실행합니다. 마우스 클릭도 됩니다.
