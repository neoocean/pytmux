...
### [H] 1.7 ssh 로 원격 pytmux 접속 시 이중 실행·재접속 루프 → 원격 탭 어태치로 전환 (요청 2026-06-12) ✅ **완결(2026-06-12) — Stage 0~3 + 실 ssh(office1) 라이브 검증** · 후속 할일 2건(§1.7-a/b, 2026-06-13)
...
- **[할일] §1.7-a 원격 탭/패널 색 구분 — 연두색 (요청 2026-06-13)**: `remote-attach` 로
  붙은 원격 탭(탭바 `⇄…` 항목)과 그 탭 진입 시 패널 외곽선을 로컬과 같은 파란색이
  아니라 **연두색**으로 그려 로컬 탭/패널과 한눈에 구분되게 한다. 클라 렌더(탭바
  세그먼트 + 외곽선 스타일)에서 원격 여부(`⇄` 병합 탭) 기준 색 분기.
